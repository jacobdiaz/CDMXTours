      ...
      <div className='grid md:grid-cols-2 gap-5'>
        ...
        <div className='my-5'>
          ...
          <p>
            ...
            love for Mexico City and all the amazing sights it has to offer! Our
            goal is to provide you with an unforgettable bike tour experience
            that will leave you with a newfound appreciation for this vibrant
            city.
          </p>
          ...
          <p>
            ...
            years of experience leading bike tours in Mexico City, we have honed
            our skills and are well-equipped to navigate the city's bustling
            streets and hidden gems. We take pride in providing safe,
            informative, and enjoyable bike tours for all ages and skill levels.
          </p>
